...
const MainScene = {
  ...
  create: async function(){
    ...
    this.player = this.physics.add.sprite(Phaser.Math.Between(1200, 1600), Phaser.Math.Between(1200, 1600), 'ship')
        .setScale(0.3);
      ...
      try{
        ...
        if(obj.type === "collision"){
          if(obj.name === metadata.name){
            this.player.setPosition(Phaser.Math.Between(1200, 1600),Phaser.Math.Between(1200, 1600));
